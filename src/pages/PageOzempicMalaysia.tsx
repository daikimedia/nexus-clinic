          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                ...
                Kuala Lumpur. Our GLP-1 Liraglutide treatment helps you achieve
                sustainable weight loss without feeling deprived.
              </motion.p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                ...
                been proven highly effective for weight management. It mimics a
                hormone that helps regulate appetite and satiety, making it
              ...
              >
                ...
                <div className="flex items-center gap-1 mb-4">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={i} className="w-5 h-5 text-wine fill-current" />
                  ))}
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="font-georgia text-brown">{testimonial.name}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
